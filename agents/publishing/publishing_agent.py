...
from base import PublishingAdapter
from mock_adapters import ALL_ADAPTERS
...
class PublishingAgent:
    ...
    def __init__(self, adapters: dict[Platform, PublishingAdapter] | None = None):
        ...
        # pass a custom mapping: PublishingAgent(adapters={Platform.SPOTIFY: RealSpotifyAdapter(), ...})
