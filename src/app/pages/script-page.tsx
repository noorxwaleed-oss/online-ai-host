...
import { Plus, Trash2, Play, Library, ScanSearch, FileEdit, Users, Palette, Rocket } from 'lucide-react';
...
export function ScriptPage() {
  ...
  const PersonaCard = ({
    ...
    <div className="flex-1">
      ...
      {/* Speaking Speed */}
      <div className="mb-4">
        <label className="block text-sm mb-2">Speaking Speed: {persona.speed.toFixed(1)}x</label>
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            step="0.1"
            value={persona.speed}
            onChange={(e) => onChange({ ...persona, speed: parseFloat(e.target.value) })}
            className="flex-1"
          />
