...
from backend.agents.prompts import ANALYZER_PROMPT, TRANSLATOR_PROMPT
from backend.agents.llms import BASE_URL, MODEL_NAME
from backend.config.settings import settings

client = OpenAI(base_url=BASE_URL, api_key=settings.OPENROUTER_API_KEY)
